...
def plot_perfil_termosal(file_path):
    ...
    df = pd.read_csv('/home/labdino/PycharmProjects/CTDprocessing/dados/01. Dados Brutos/01_radial_1/0626_28072019_1609/FILE1_binado.csv')
    ...
    # Plotar Temperatura no primeiro eixo x
    ...
    plt.title('Perfil de Temperatura e Salinidade')
    ...
    plt.savefig('/home/labdino/PycharmProjects/CTDprocessing/dados/01. Dados Brutos/01_radial_1/0626_28072019_1609/nome.png', format='png', dpi=900, transparent=False)

    # Exibir o gráfico
    plt.show()

# Substitua 'caminho/do/seu/arquivo.csv' pelo caminho real do seu arquivo CSV
plot_perfil_termosal('/home/labdino/PycharmProjects/CTDprocessing/dados/01. Dados Brutos/01_radial_1/0626_28072019_1609/FILE1_binado.csv')
